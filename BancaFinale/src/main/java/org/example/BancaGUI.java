...
public class BancaGUI extends JFrame {
    ...
    // Hashmap for investment details
    ...
    private JPanel createActionPanel() {
        ...
        prelievoButton.setPreferredSize(new Dimension(150, 25));
        ...
        investimentoButton.setPreferredSize(new Dimension(150, 25));
        panel.add(investimentoButton);

        /*
        JButton blankButton = createStyledButton("", "");
        blankButton.setEnabled(false); // Disable the blank button
        blankButton.setPreferredSize(new Dimension(150, 25));
        panel.add(blankButton);
        */                       //bottone commentato perchè non sono capace di fare il grafico.
    ...
    private JPanel createLogPanel() {
        ...
        logArea.setFont(new Font("Monospaced", Font.PLAIN, 15)); // font and size
    ...
    private Border createFancyBorder(String title) {
        TitledBorder titledBorder = BorderFactory.createTitledBorder(
                BorderFactory.createLineBorder(HIGHLIGHT_COLOR, 4),
                title
        );
    ...
    private void updateDisplay() {
        ...
        depositButton.setEnabled(user.getPortafoglio() > 0);    // cant deposit if portfolio is 0
        prelievoButton.setEnabled(user.getContoBancario() > 0); // cant deposit if bank balance is 0
        saveUserData();
    }
    ...
    // Logout that brings you to the login page
    ...
    @SuppressWarnings("unchecked")  // doesnt show warnings
...
// Project made by Bincoeltto Diego and Zago Gianluca