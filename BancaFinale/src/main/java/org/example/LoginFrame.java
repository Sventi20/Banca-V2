...
public class LoginFrame extends JFrame {
    ...
    private void setupUI() {
        ...
        setExtendedState(JFrame.MAXIMIZED_BOTH); // Makes the window fullscreen
        setSize(400, 350);
        setLocationRelativeTo(null);
        setResizable(true); // Makes the window non-resizable
        ...
        usernameLabel.setFont(new Font("SansSerif", Font.BOLD, 18)); //font and size
    ...
    // checks if password and username work
